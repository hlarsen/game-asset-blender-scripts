...
USAGE = "Usage: blender --background --python synty-kaiju.py -- <input_dir> <output_dir>"
...
FILE_REPLACEMENTS = {
    "PolygonKaiju_Texture_01.psd": "PolygonKaiju_Texture_01.png",
    "Buildings_Diffuse_01.png": "Highrise_Diffuse_01.png",
...
def main():
    ...
    # check paths
    fbx_path = os.path.join(input_path, "SourceFiles", "FBX")
    if not os.path.isdir(fbx_path):
        raise FileNotFoundError(f"FBX path not found")

    textures_path = os.path.join(input_path, "SourceFiles", "Textures")
